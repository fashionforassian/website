...
"[project]/website/frontend/components/providers/CartProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CartProvider.useMemo[value]": ()=>{
            const cartCount = items.reduce({
                "CartProvider.useMemo[value].cartCount": (sum, item)=>sum + item.quantity
            }["CartProvider.useMemo[value].cartCount"], 0);
            const subtotal = items.reduce({
                "CartProvider.useMemo[value].subtotal": (sum, item)=>sum + item.price * item.quantity
            ...
            return {
                ...
                subtotal,
                addToCart: ({
                    "CartProvider.useMemo[value]": (input)=>{
                        const quantity = Math.max(1, input.quantity ?? 1);
                        const lineId = buildLineId(input);
                        setItems({
                            "CartProvider.useMemo[value]": (current)=>{
                                const existing = current.find({
                                    "CartProvider.useMemo[value].existing": (item)=>item.lineId === lineId
                                }["CartProvider.useMemo[value].existing"]);
                                if (existing) {
                                    return current.map({
                                        "CartProvider.useMemo[value]": (item)=>item.lineId === lineId ? {
                                                ...item,
                ...
                updateQuantity: ({
                    "CartProvider.useMemo[value]": (lineId, quantity)=>{
                        const normalized = Math.max(1, quantity);
                        setItems({
                            "CartProvider.useMemo[value]": (current)=>current.map({
                                    "CartProvider.useMemo[value]": (item)=>item.lineId === lineId ? {
                                            ...item,
                                            quantity: normalized
                                        } : item
                ...
                removeFromCart: ({
                    "CartProvider.useMemo[value]": (lineId)=>{
                        setItems({
                            "CartProvider.useMemo[value]": (current)=>current.filter({
                                    "CartProvider.useMemo[value]": (item)=>item.lineId !== lineId
                                }["CartProvider.useMemo[value]"])
                        }["CartProvider.useMemo[value]"]);
                    }
...
_s(CartProvider, "XLdST3qrtYusqQwcPVLKbsBrkoo=");
_c = CartProvider;
function useCart() {
    _s1();
...
"[project]/website/frontend/lib/data.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/website/frontend/components/Navbar.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$components$2f$providers$2f$CartProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/website/frontend/components/providers/CartProvider.tsx [app-client] (ecmascript)");
...
function Navbar() {
    ...
    const { cartCount } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$components$2f$providers$2f$CartProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                        ...
                        children: __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["navCategories"].map((item)=>{
            ...
            mobileOpen ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                    ...
                    children: [
                        __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["navCategories"].map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    href: item.href,
...
_s(Navbar, "ijd4JKtRkg+ZPaKBdZSQ0vsNcuo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$components$2f$providers$2f$CartProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"]
    ];
});
_c = Navbar;
var _c;
...
"[project]/website/frontend/components/SmoothScrollProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SmoothScrollProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SmoothScrollProvider.useEffect": ()=>{
            ...
            const lenis = new __TURBOPACK__imported__module__$5b$project$5d2f$website$2f$frontend$2f$node_modules$2f2e$pnpm$2f$lenis$40$1$2e$3$2e$18_react$40$19$2e$2$2e$3$2f$node_modules$2f$lenis$2f$dist$2f$lenis$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]({
                duration: 1.2,
                easing: {
            ...
            const handleWheel = {
                "SmoothScrollProvider.useEffect.handleWheel": (e)=>{
                // Let Lenis handle the scroll
                }
            }["SmoothScrollProvider.useEffect.handleWheel"];
...
_s(SmoothScrollProvider, "CQRBFKptXZT4hPSp/wy3vNOz8os=");
...
//# sourceMappingURL=website_frontend_8a9dd4d6._.js.map