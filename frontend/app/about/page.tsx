  ...
  return (
    <main>
      <section className="mx-auto w-full max-w-[1200px] px-4 py-14 md:px-8 md:py-20">
        <p className="mb-3 text-xs uppercase tracking-[0.2em] text-neutral-500">About Fashion Asia</p>
        ...
        <p className="mt-6 max-w-3xl text-base leading-8 text-[#222222]">
          Fashion Asia is a fast-fashion house dedicated to elevated essentials and directional seasonal
      ...
      <section className="mx-auto w-full max-w-[1200px] px-4 py-14 md:px-8 md:py-20">
        ...
        <p className="mt-5 max-w-3xl text-base leading-8 text-[#222222]">
          ...
          strong emphasis on fit, fabrication, and relevance. Fashion Asia exists to deliver collections
